...
namespace DesafioBase2.Bases
{
    public class PageBase
    {
        ...
        protected void RetornaDadosString(By locator)
        {
             WaitForElement(locator).ToString();
        ...
        protected string GetTextError(By locator)
        {
            try
            {
                string text = WaitForElement(locator).Text;
        ...
        protected bool ReturnIfElementExist(By locator)
        {
            try
            {
                wait.Until(ExpectedConditions.ElementExists(locator));
